...
Версия v1.1.3 совместима с Integrated Demonlist: Global Demonlist автоматически переносится отдельной строкой ниже AREDL. Также сохранены исправление наложения на звёзды, толстая рамка с прозрачными углами и англоязычное градиентное описание внутри Geode.
