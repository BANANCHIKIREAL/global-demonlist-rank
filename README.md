...
Версия v1.1.0 исправляет наложение позиции на количество звёзд, добавляет новую иконку с округлой рамкой и расширенное градиентное описание внутри Geode.
